...
# TBD do the normality test

```{r}
cm <- ggplot(df, aes(x=compactness_mean, group=diagnosis,fill=diagnosis)) +
geom_density(alpha=0.5) +
scale_fill_manual(values = c("#0468BF","#D9A23D")) + 
theme_bw()

pw <- ggplot(df, aes(x=perimeter_worst, group=diagnosis,fill=diagnosis)) +
geom_density(alpha=0.5) +
scale_fill_manual(values = c("#0468BF","#D9A23D")) + 
theme_bw()

cw <- ggplot(df, aes(x=concavity_worst, group=diagnosis,fill=diagnosis)) +
geom_density(alpha=0.5) +
scale_fill_manual(values = c("#0468BF","#D9A23D")) + 
theme_bw()

cp <- ggplot(df, aes(x=concave.points_worst, group=diagnosis,fill=diagnosis)) +
geom_density(alpha=0.5) +
scale_fill_manual(values = c("#0468BF","#D9A23D")) + 
theme_bw()
